...
const ShoppingCart: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      {books.length === 0 && recentlyRemovedList.length === 0 ? (
        <div className="bg-white rounded-b shadow p-6 text-center text-gray-500 italic">
          Aún no has añadido libros al carrito.
        </div>
      ) : (
        <>
          <div className="bg-white rounded-b overflow-hidden shadow">
            {/* Estructura de carrito completa aquí */}
